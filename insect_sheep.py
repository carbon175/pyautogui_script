...
# 图片资源路径
img_whistle = os.path.join(base_path, 'whistle_sheep.png')
img_ball = os.path.join(base_path, 'ball_sheep.png')
img_turn = os.path.join(base_path, 'turn_sheep.png')
img_beetle = os.path.join(base_path, 'beetle_sheep.png')
img_candy = os.path.join(base_path, 'candy_sheep.png')
img_war = os.path.join(base_path, 'war_sheep.png')

bug_images = [
    os.path.join(base_path, 'bug1_sheep.png'),
    os.path.join(base_path, 'bug2_sheep.png'),
    os.path.join(base_path, 'bug3_sheep.png'),
    os.path.join(base_path, 'bug4_sheep.png'),
    os.path.join(base_path, 'bug5_sheep.png'),
    os.path.join(base_path, 'bug6_sheep.png'),
]
