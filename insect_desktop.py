...
# 图片资源路径
img_whistle = os.path.join(base_path, 'whistle_desktop.png')
img_ball = os.path.join(base_path, 'ball_desktop.png')
img_turn = os.path.join(base_path, 'turn_desktop.png')
img_beetle = os.path.join(base_path, 'beetle_desktop.png')
img_candy = os.path.join(base_path, 'candy_desktop.png')
img_war = os.path.join(base_path, 'war_desktop.png')
img_power60 = os.path.join(base_path, 'power_bar_60_desktop.png')

bug_images = [
    os.path.join(base_path, 'bug1_desktop.png'),
    os.path.join(base_path, 'bug2_desktop.png'),
    os.path.join(base_path, 'bug3_desktop.png'),
    os.path.join(base_path, 'bug4_desktop.png'),
    os.path.join(base_path, 'bug5_desktop.png'),
    os.path.join(base_path, 'bug6_desktop.png'),
]
